...
try {
    ...
    console.log("Firebase Admin Setup Warning:", e.message);
}
...
<div class="app-container">
  ...
  <div id="page1" class="page active-page">
    ...
    <div class="input-group">
      ...
      <div class="password-wrapper">
        ...
        <span class="toggle-eye" onclick="toggleField('password', this)">👁️</span>
      </div>
    </div>
    <button type="button" class="btn" onclick="doLogin()">LOGIN</button>
    <button type="button" class="btn btn-pkg" onclick="openPkg()">🔒 SEE PACKAGES</button>
  </div>
  ...
  <div id="page2" class="page">
    ...
    <div class="input-group">
      ...
      <div class="password-wrapper">
        ...
        <span class="toggle-eye" onclick="toggleField('secCode', this)">👁️</span>
      </div>
    </div>
    <button type="button" class="btn" onclick="doVerify()">VERIFY ACCESS</button>
  </div>
  ...
  <div id="page3" class="page">
    ...
    <div class="fixer-box">
      ...
      <button type="button" class="btn" onclick="doNext()">⚡ NEXT ROUND &gt;&gt;</button>
    </div>
...
<script>
  ...
  try {
    ...
    console.log("Firebase Init Safe Exception");
  }
  ...
  function toggleField(id, el) {
    ...
    el.innerText = elem.type === 'password' ? '👁️' : '🙈';
  }

  // Inline Handlers (No Event Listener issues)
  function doLogin() {
    ...
    if (typeof firebase !== 'undefined' && firebase.database) {
      ...
      showCustomAlert('❌ Database not ready. Please try again.');
    }
  }
