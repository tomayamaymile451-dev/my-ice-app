...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Rajdhani', sans-serif; }
        ...
        /* Pure CSS Casino Wheel Background */
        .wheel-bg {
            position: fixed;
            top: 50%; left: 50%;
        ...
        .wheel-overlay {
            ...
            background: radial-gradient(circle, rgba(2,7,18,0.2) 0%, rgba(2,7,18,0.85) 80%);
            z-index: 1;
            pointer-events: none;
        }
        ...
        .input-box {
            ...
            font-size: 14px;
            outline: none;
            box-shadow: inset 0 0 8px rgba(0, 210, 255, 0.3), 0 0 8px rgba(0, 210, 255, 0.2);
            transition: 0.3s;
        }
        .input-box:focus {
        ...
        .btn-pkg {
            ...
            color: #fff;
            box-shadow: 0 0 15px rgba(209, 0, 209, 0.6);
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="header">
        <div class="header-left">
            <svg class="hook-icon" viewBox="0 0 24 24" fill="none" stroke="#00d2ff" stroke-width="2">
                <path d="M18 15a6 6 0 0 1-12 0V4a2 2 0 0 1 4 0v11a2 2 0 0 0 4 0V9"/>
                <circle cx="18" cy="15" r="1" fill="#00d2ff"/>
            </svg>
            <div>
    ...
    <div class="container">
        <div class="logo-wrapper">
            <svg class="logo-svg" viewBox="0 0 220 140" xmlns="http://www.w3.org/2000/svg">
                <!-- Outer Wheel Border -->
                <circle cx="110" cy="70" r="55" fill="none" stroke="#00d2ff" stroke-width="3" stroke-dasharray="8 4"/>
                <!-- Fishing Rod & Hook -->
                <path d="M60 90 Q 110 20, 160 85" fill="none" stroke="#00d2ff" stroke-dasharray="3 3" stroke-width="2"/>
                <!-- Fish Icon -->
                <path d="M95 65 Q 110 50, 130 65 Q 110 80, 95 65 Z" fill="#ff4d4d" stroke="#ff8080" stroke-width="1.5"/>
                <polygon points="130,65 140,58 140,72" fill="#ff4d4d"/>
                <circle cx="102" cy="62" r="2" fill="#fff"/>
                
                <!-- Glowing Text -->
                <text x="110" y="105" font-family="'Orbitron', sans-serif" font-weight="900" font-size="19" fill="#ffffff" text-anchor="middle" style="text-shadow: 0 0 8px #00d2ff;">ICE FISHING</text>
                <text x="110" y="122" font-family="'Orbitron', sans-serif" font-weight="700" font-size="11" fill="#00d2ff" text-anchor="middle" letter-spacing="3">LIVE</text>
            </svg>
        </div>
