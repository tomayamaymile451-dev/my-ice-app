...
(function() {
  ...
  pkgBtn.addEventListener('click', function(e) {
    e.preventDefault();
    var targetUrl = telegramWebLink || telegramDeepLink || defaultTelegramLink;

    if (targetUrl.startsWith('tg://join?invite=')) {
      var inviteCode = targetUrl.replace('tg://join?invite=', '');
      targetUrl = 'https://t.me/joinchat/' + inviteCode;
    } else if (targetUrl.startsWith('tg://resolve?domain=')) {
      var domain = targetUrl.replace('tg://resolve?domain=', '');
