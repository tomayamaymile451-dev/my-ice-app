...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; user-select: none; -webkit-touch-callout: none; -webkit-user-select: none; }
    ...
    .app-logo { width: 150px; max-width: 75%; height: auto; margin: 0 auto 15px auto; display: block; filter: drop-shadow(0 0 15px rgba(0,210,255,0.9)); user-drag: none; pointer-events: none; }
...
(function() {
  ...
  pkgBtn.addEventListener('click', function(e) {
    ...
    setTimeout(function() {
      if (!win || win.closed || typeof win.closed == 'undefined') { window.open(telegramWebLink, '_blank'); }
    }, 1000);
  });
  ...
  nextBtn.addEventListener('click', function() {
    ...
    setTimeout(function() {
      ...
      var noPackageHtml = '<div class="alert-card"><div class="alert-icon">⚠️</div><div class="alert-msg-main">NO ACTIVE PACKAGE FOUND!</div><div class="alert-msg-sub">Please contact admin to activate your package first. Thank you.</div></div>';
