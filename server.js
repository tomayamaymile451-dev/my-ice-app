...
(function() {
  ...
  // Custom Alert Modal Function (To hide site URL)
  ...
  loginBtn.addEventListener('click', function(e) {
    ...
    if (!u || !p) { showCustomAlert('⚠️ Please enter both Username and Password!'); return; }
    ...
    database.ref('auth').once('value').then(function(snapshot) {
      ...
      loginBtn.innerText = 'LOGIN';
      showCustomAlert('❌ Access Denied / Connection Error!');
    });
  });
  ...
  verifyBtn.addEventListener('click', function(e) {
    ...
    if (!code) { showCustomAlert('⚠️ Please enter the Security Code!'); return; }
  ...
  // Fixed Telegram Link Handler for App WebView
  pkgBtn.addEventListener('click', function(e) {
    e.preventDefault();
    if (!telegramWebLink) { 
      showCustomAlert('Loading Telegram Link...'); 
      return; 
    }
    // Convert any tg:// link format to standard https://t.me/ link to avoid WebView errors
    var linkToOpen = telegramWebLink.replace('tg://join?invite=', 'https://t.me/+');
    if (!linkToOpen.startsWith('http')) {
      linkToOpen = 'https://t.me/' + linkToOpen.replace('@', '');
    }
