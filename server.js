...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Rajdhani', sans-serif; }
        ...
        /* Original Casino Wheel & Host Background Image */
        .bg-overlay {
            position: fixed;
            top: 0; left: 0; width: 100%; height: 100%;
            background: url('https://i.ibb.co/L5T1c8x/1000031666.jpg') no-repeat center top / cover;
            z-index: 0;
            opacity: 0.55;
        ...
        /* Top Title Bar with Animated Elements */
        .header {
            width: 100%;
            padding: 10px 14px;
            display: flex;
        ...
        .dot-blue {
            ...
            animation: dot-glow 1.5s infinite alternate 0.5s;
        }
        .dot-purple {
            background: #d100d1;
            box-shadow: 0 0 8px #d100d1;
            animation: dot-glow 1.5s infinite alternate 1s;
        }
        ...
        .input-box:focus {
            box-shadow: inset 0 0 12px rgba(0, 210, 255, 0.5), 0 0 20px rgba(0, 210, 255, 0.9);
        }
        ...
        /* Buttons matching Original Screenshot Colors */
        .btn {
            width: 100%;
            padding: 13px;
            border-radius: 12px;
        ...
        /* Login Button: Cyan / Sky Blue Glow */
        .btn-login {
        ...
        /* See Packages Button: Purple Gradient with Lock Icon */
        .btn-pkg {
...
<body>
    ...
    <div class="container">
        <!-- Original Logo Image embedded directly -->
        <img class="original-logo" src="https://i.ibb.co/VMy4SCh/1000031660.png" alt="ICE FISHING LIVE">
